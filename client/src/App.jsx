...
// NEW: Service detail page for individual service routes
    ...
    <>   
      ...
      <Routes>
        <Route element={<UserLayout />}>
          ...
          {/* NEW: dynamic route for individual product/service pages
              Examples:
                /products/solar-pv-consulting
                /products/e-bike-manufacturing
          */}
          <Route
            path="products/:serviceSlug"
            element={<><PageHelmet metadata={routeMetadata.products} /><ServiceDetailPage /></>}
          />

          {/* Optional: also support URLs under /services/<slug> */}
          <Route
            path="services/:serviceSlug"
            element={<><PageHelmet metadata={routeMetadata.services} /><ServiceDetailPage /></>}
          />
