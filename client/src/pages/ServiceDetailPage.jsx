  ...
  return (
    ...
    <div className="min-h-screen bg-gray-300 text-black dark:bg-[#030326] pt-24 py-12">
      <div className="max-w-4xl mx-auto px-4">
        {/* Page Title */}
        <h1 className="text-3xl dark:text-white font-bold mb-4">{product.name}</h1>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold dark:text-white mb-2">Key Features</h2>
          ...
          <div className="md:flex dark:text-white md:items-start gap-6">
            ...
            <div className="md:w-1/2 dark:text-white grid gap-4">
              {Object.entries(product.specifications).map(([k, v]) => (
                ...
                >
                  <div className="text-sm dark:text-gray-400 text-gray-500">{k}</div>
        ...
        {/* Benefits */}
        <section>
          <h2 className="text-2xl dark:text-white font-semibold mb-4">Benefits</h2>
